...
help:
	...
	@echo "========================================================================"
	@echo "  make scaffold           - Regenerate analysis figures, export & compile scaffold PDF"
...
container-scaffold:
	...
	podman run --rm -v .:/app:z --entrypoint python biblio-pipeline /app/scripts/regenerate_figures.py $(OUT_DIR)
