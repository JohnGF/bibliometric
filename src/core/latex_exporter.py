...
class LaTeXExporter:
    ...
    def _build_scaffold_content(self, title: str, onecolumn: bool = False) -> str:
        tex = []
        if onecolumn:
            tex.append("\\documentclass[journal,onecolumn]{IEEEtran}")
        else:
        ...
        tex.append("    \\IfFileExists{figures/Figure_1.pdf}{\\includegraphics[width=0.95\\linewidth]{Figure_1.pdf}}{}")
        tex.append("    \\caption{Publication Count and Annual Growth}")
        tex.append("    \\label{fig:pubCountGrowth}")
        tex.append("\\end{figure}")
        tex.append("")
        # Leave a clean import check
        ...
        tex.append("\\begin{figure}[htbp]")
        tex.append("    \\centering")
        tex.append("    \\IfFileExists{figures/Figure_20.pdf}{\\includegraphics[width=0.95\\linewidth]{Figure_20.pdf}}{}")
        ...
        tex.append("\\begin{figure}[htbp]")
        tex.append("    \\centering")
        tex.append("    \\IfFileExists{figures/Figure_22.pdf}{\\includegraphics[width=0.95\\linewidth]{Figure_22.pdf}}{}")
        ...
        tex.append("\\begin{figure}[htbp]")
        tex.append("    \\centering")
        tex.append("    \\IfFileExists{figures/Figure_25.pdf}{\\includegraphics[width=0.95\\linewidth]{Figure_25.pdf}}{}")
        ...
        tex.append("\\begin{figure}[htbp]")
        tex.append("    \\centering")
        tex.append("    \\IfFileExists{figures/Figure_15.pdf}{\\includegraphics[width=0.95\\linewidth]{Figure_15.pdf}}{}")
        ...
        tex.append("\\begin{figure}[htbp]")
        tex.append("    \\centering")
        tex.append("    \\IfFileExists{figures/Figure_8.pdf}{\\includegraphics[width=0.95\\linewidth]{Figure_8.pdf}}{}")
        ...
        tex.append("\\begin{figure}[htbp]")
        tex.append("    \\centering")
        tex.append("    \\IfFileExists{figures/Figure_10.pdf}{\\includegraphics[width=0.95\\linewidth]{Figure_10.pdf}}{}")
        ...
        tex.append("\\begin{figure}[htbp]")
        tex.append("    \\centering")
        tex.append("    \\IfFileExists{figures/Figure_5.pdf}{\\includegraphics[width=0.95\\linewidth]{Figure_5.pdf}}{}")
        ...
        tex.append("\\IfFileExists{tables/tab_Biblio.tex}{\\input{tables/tab_Biblio.tex}}{}")
        tex.append("")
    ...
    def export_paper_scaffold(self, title: str = "Automated Bibliometric Review"):
        """Generates both standard (2-column, column-shrunk figures) and full-page 1-column paper templates."""
        ...
        content_twocol = self._build_scaffold_content(title, onecolumn=False)
        content_onecol = self._build_scaffold_content(title, onecolumn=True)

        with open(scaffold_path, "w", encoding="utf-8") as f:
            f.write(content_twocol)
        logger.info(f"LaTeXExporter: Generated 2-column paper scaffold -> {scaffold_path}")

        with open(onecol_path, "w", encoding="utf-8") as f:
            f.write(content_onecol)
        logger.info(f"LaTeXExporter: Generated 1-column paper scaffold -> {onecol_path}")
